<?php
namespace andrewdanilov\gridtools\behaviors;
...
class DateBehavior extends \yii\base\Behavior
{
	/**
	 * 'dateAttributes' => [
	 *  	'created_at' => \andrewdanilov\gridtools\behaviors\DateBehavior::DATETIME_FORMAT,
	 *  	'updated_at' => \andrewdanilov\gridtools\behaviors\DateBehavior::DATE_FORMAT,
	 *  	'showed_at', // equal to: 'showed_at' => \andrewdanilov\gridtools\behaviors\DateBehavior::DATE_FORMAT
	 *	],
	 */
